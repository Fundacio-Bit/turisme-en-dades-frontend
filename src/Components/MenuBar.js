...
const MenuBar = (props) => {
  ...
  return (
    <div className="ant-row">
      <div className="ant-col ant-col-xl-18">
        <Menu
        ...
        <div className="ant-col ant-col-xl-6 ant-col-xs-24" style={{ borderBottom: '1px solid #f0f0f0'}}>
            <div style={{ margin: 5, fontWeight: "bold" }}>
              <div style={{ float: "left", marginRight: 5, marginTop: 5 }}>MES</div>
            </div>
